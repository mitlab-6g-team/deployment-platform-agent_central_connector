...
def unsubscribe(payload):
    """
    Call central_operation.ModelMetadataWriter.unsubscribe API
    """
    module_name_str = config.CENTRAL_OPERATION.NAME
    actor_name_str = "TopicSubscriber"
...
def resubscribe(payload):
    """
    Call central_operation.ModelMetadataWriter.resubscribe API
    """
    module_name_str = config.CENTRAL_OPERATION.NAME
    actor_name_str = "TopicSubscriber"
    function_name_str = "resubscribe"
